    ...
    return (
        <div className="incident-page fade-in">
                ...
                <div className="section">
                    ...
                    <div className="section-content">
                        ...
                        <div className="confidence-bar">
                            ...
                            <div className="confidence-track" style={{ flex: 1, height: '4px', background: 'rgba(255,255,255,0.1)', borderRadius: '2px', overflow: 'hidden', margin: '0 12px' }}>
                                <div
                            ...
                            <span className="confidence-value" style={{ color: confidenceColor, fontWeight: 700 }}>
                        ...
                        {rca.impact_description && (
                            <div className="impact-text" style={{ marginTop: '20px', fontSize: '14px' }}>
                            ...
                            <div key={action.id} className="action-card">
                                <div className="action-card-header">
                                    <div className="action-card-title">
                                        {action.title}
                                        <span className={`risk-tag ${action.risk_level}`} style={{ marginLeft: '12px', fontSize: '10px', padding: '2px 8px', borderRadius: '4px', background: 'rgba(255,255,255,0.1)' }}>
                                            {action.risk_level} risk
                                        </span>
                                    </div>
                                    <StatusBadge type="approval" value={action.approval_status} />
                                </div>
                                <div className="action-card-body" style={{ padding: '24px' }}>
                                    <div className="action-description" style={{ marginBottom: '16px', color: 'var(--text-secondary)' }}>{action.description}</div>
                                    {action.command_hint && (
                                        <div className="action-command">{action.command_hint}</div>
                                    )}
                                    {action.rollback_description && (
                                        <div className="action-rollback" style={{ fontSize: '12px', color: 'var(--text-muted)', fontStyle: 'italic' }}>
            ...
            <div className="section">
                ...
                <div className="section-content">
                    <div className="services-grid" style={{ display: 'flex', flexWrap: 'wrap', gap: '12px' }}>
                        {incident.affected_services?.map((svc) => (
                            <div key={svc} className="service-chip" style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 16px', background: 'rgba(255,255,255,0.05)', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.1)' }}>
